...
namespace BasketballForEveryone.Controllers
{
    ...
    {
        private readonly IBestPlayersService _bestPlayersService;
        private readonly ShoppingCart _shoppingCart;
        private readonly IOrdersService _ordersService;
        

        public OrdersController(IBestPlayersService bestPlayersService, ShoppingCart shoppingCart, IOrdersService ordersService)
        {
        ...
        {
            var item = await _bestPlayersService.GetBestPlayersByIdAsync(id);
